...
var RouterUserSunSet = express.Router();
...
//create router
RouterUserSunSet.get("/", (req, res) => {
  res.send("Router Api");
});

// router and params
RouterUserSunSet.get("/:id", (req, res) => {
  res.send("Router Api" + req.params.id);
});

// create user
RouterUserSunSet.post("/register", async (req, res) => {
  try {
...
// login
RouterUserSunSet.post("/login", async (req, res) => {
  try {
...
module.exports = RouterUserSunSet;